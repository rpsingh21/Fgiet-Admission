...
class HighSchoolModelAdmin(admin.ModelAdmin):
    list_display = ['candidate','highSchoolPassingYear','highSchoolBoard','highSchoolRollNo','highSchoolPercentageMarks']
...
class IntermediateModelAdmin(admin.ModelAdmin):
    list_display = ['candidate','intermediatePassingYear','intermediateBoard','intermediateRollNo','intermediatePercentageMarks']
...
class UgOrDiplomaModelAdmin(admin.ModelAdmin):
    list_display = ['candidate','ugOrDiplompassingYear','ugOrDiplomBoard','ugOrDiplomRollNo','ugOrDiplomBranch','ugOrDiplomPercentageMarks']
