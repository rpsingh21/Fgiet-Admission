...
class Sms():
    def __init__(self):
        ...
        self.cred = {
            'username': smsCred["username"], 'password': smsCred["password"]}
        self.s = requests.Session()
        self.s.headers['User-Agent'] = "Mozilla/5.0 (X11; Ubuntu; Linux \
            x86_64; rv:50.0) Gecko/20100101 Firefox/50.0"
        ...
        if "http://site21.way2sms.com/main.action" in self.q.url:
            ...
            self.loggedIn = False
        self.jid = self.s.cookies.get_dict()['JSESSIONID'][4:]
    ...
    def msgSentToday(self):
        ...
        self.msg_left_url = 'http://site21.way2sms.com/sentSMS?Token='+self.jid
